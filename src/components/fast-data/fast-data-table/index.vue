<template>
	<div class="fast-data-table">
		<el-dialog :model-value="visible" :title :close-on-click-modal="false" :width="800" draggable @close="handleClose">
			...
			>
				<el-table-column v-if="multiple" type="selection" header-align="center" align="center" width="38"></el-table-column>
...
<script setup lang="ts" name="FastDataTable">
