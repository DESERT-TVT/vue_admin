<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item prop="paramType">
				<fast-dict-select v-model="state.queryForm.paramType" dict-type="params_type" placeholder="系统参数" clearable></fast-dict-select>
			</el-form-item>
			<el-form-item>
	...
	<el-card>
		...
		>
			...
			<fast-dict-column prop="paramType" label="系统参数" dict-type="params_type"></fast-dict-column>
