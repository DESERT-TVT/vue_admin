<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item prop="status">
				<fast-dict-select v-model="state.queryForm.status" dict-type="success_fail" placeholder="登录状态" clearable></fast-dict-select>
			</el-form-item>
			<el-form-item>
	...
	<el-card>
		...
		>
			...
			<fast-dict-column prop="status" label="登录状态" dict-type="success_fail"></fast-dict-column>
			<fast-dict-column prop="operation" label="操作信息" dict-type="login_operation"></fast-dict-column>
