<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item prop="status">
				<fast-dict-select v-model="state.queryForm.status" placeholder="操作状态" dict-type="success_fail" clearable></fast-dict-select>
			</el-form-item>
			<el-form-item>
	...
	<el-card>
		...
		>
			...
			<el-table-column align="center" header-align="center" label="操作行为" prop="name"></el-table-column>
			...
			<fast-dict-column prop="operateType" label="操作类型" dict-type="log_operate_type" header-align="center" align="center"></fast-dict-column>
			...
			<fast-dict-column prop="status" label="操作状态" dict-type="success_fail"></fast-dict-column>
