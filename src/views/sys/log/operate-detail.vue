<template>
	<el-dialog v-model="visible" title="日志详情" :close-on-click-modal="false" align-center>
		<el-form label-width="100px">
			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="操作类型">
						<fast-dict-select v-model="dataForm.operateType" dict-type="log_operate_type" disabled style="width: 100%"></fast-dict-select>
					</el-form-item>
				</el-col>
				<el-col :span="12">
			...
			<el-form-item v-if="dataForm.exceptionMsg" label="异常信息">
				<el-input v-model="dataForm.exceptionMsg" :rows="8" type="textarea" disabled />
			</el-form-item>
		</el-form>
		<template #footer>
...
const init = (data?: any) => {
	...
	useLogOperateException({ id: dataForm.id }).then(res => {
		dataForm.exceptionMsg = res.data
	})
}
