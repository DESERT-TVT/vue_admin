	...
	<el-dialog v-model="visible" :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false">
		<el-form ref="dataFormRef" :model="dataForm" :rules="dataRules" label-width="100px" @keyup.enter="submitHandle()">
			<el-form-item label="平台类型" prop="platform">
				<fast-dict-select v-model="dataForm.platform" dict-type="sms_platform" placeholder="平台类型" style="width: 100%"></fast-dict-select>
			</el-form-item>
			<el-form-item v-if="dataForm.platform == 3 || dataForm.platform == 4" label="接入地址" prop="url">
			...
			<el-form-item v-if="dataForm.platform != 2 && dataForm.platform != 4" label="短信签名" prop="signName">
			...
			<el-form-item v-if="dataForm.platform != 4" label="AccessKey" prop="accessKey">
				<el-input v-model="dataForm.accessKey" placeholder="AccessKey"></el-input>
			</el-form-item>
			<el-form-item v-if="dataForm.platform == 4" label="用户名" prop="appId">
				<el-input v-model="dataForm.appId" placeholder="UID"></el-input>
			</el-form-item>
			<el-form-item v-if="dataForm.platform == 4" label="接口密码" prop="secretKey">
				<el-input v-model="dataForm.secretKey" placeholder="SecretKey"></el-input>
			</el-form-item>
			<el-form-item v-if="dataForm.platform != 4" label="SecretKey" prop="secretKey">
				<el-input v-model="dataForm.secretKey" placeholder="SecretKey"></el-input>
			</el-form-item>
