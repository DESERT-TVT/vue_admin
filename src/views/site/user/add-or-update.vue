<template>
	<!-- 分享主播弹窗 -->
	<el-dialog v-model="visible" size="40%" title="分享主播">
		...
		<el-input v-model="state.queryForm.search" placeholder="请输入要分享的UID" style="width: 200px" />
...
import { APIGetSiteList, APISaveShareOnline } from '@/api/site/site'
