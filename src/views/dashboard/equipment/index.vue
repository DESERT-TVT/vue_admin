<template>
	<el-card>
		...
		>
			...
			<el-table-column prop="id" label="设备id" header-align="center" align="center" min-width="170" />
			<el-table-column prop="name" label="设备name" header-align="center" align="center" min-width="170" />
...
const state: IHooksOptions = reactive({
	dataListUrl: '/admin/equipment/page',
	deleteUrl: '/admin/delete/equipment',
	createdIsNeed: false,
	queryForm: {
		name: undefined,
