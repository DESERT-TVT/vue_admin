<template>
	<el-card>
		...
		>
			<el-table-column prop="uuid" label="uuid" header-align="center" align="center" min-width="100" />
			...
			<el-table-column prop="type" label="事件名称" header-align="center" align="center" min-width="150">
...
<script setup lang="ts" name="DataManagementDownloadIndex">
...
const state: IHooksOptions = reactive({
	dataListUrl: '/admin/data/downpage',
	queryForm: {
		platformId: 1,
